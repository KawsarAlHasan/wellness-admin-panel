...
const Navbar = ({ showDrawer }) => {
  ...
  const profileMenuItems = [
    ...
    {
      key: "chat-support",
      label: <ChatSupportModel />,
    },
    {
      key: "wellness-preferences",
      label: <WellnessPreferences />,
    },
    {
      key: "settings",
      ...
      <div className="flex items-center justify-between h-16">
        ...
        <div>
          <input
            type="text"
            placeholder="Search..."
            className="border border-gray-300 hidden lg:block bg-white rounded-full py-2 px-4 w-96 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
